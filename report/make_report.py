...
opts = {
    ...
    'tests': ["Per base sequence quality", "Per tile sequence quality",
        ...
        'qcCaptions': {
    "Per base sequence quality": ("Per-base sequence quality failed MSL standards.", "Per-base sequence quality passed MSL standards."),
    "Per tile sequence quality": ("Per-tile sequence quality failed MSL standards.", "Per-tile sequence quality passed MSL standards."),
